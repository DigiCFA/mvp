...
export async function createMongooseConnection() {
  ...
  // conn could be retained between function calls (due to callbackWaitsForEmptyEventLoop in Lambda.js) to increase efficiency
  if (conn == null) {

    console.log("CREATING NEW MONGOOSE CONNECTION")
    
    conn = mongoose.connect(ATLAS_URI, {

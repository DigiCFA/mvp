...
const SetPasswordScreen = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            ...
            <HideKeyboardView>
                <View className="mx-3">
                    <Text className="font-semibold" style={{fontSize: 30}} >How you'll log in</Text>
                    <Text className="font-medium" style={{fontSize: 18}}>Make sure you keep it secure.</Text>
                </View>
            </HideKeyboardView>

            <View className="mx-3">
                <PasswordTextInput placeHolder={"Password"} onChangeText={setPassword}/>
                <PasswordTextInput placeHolder={"Retype Password"} onChangeText={setRetypedPassword} />
            </View>
